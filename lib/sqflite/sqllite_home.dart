...
import 'package:widgets/sqflite/car_class.dart';
import 'package:widgets/sqflite/sqllite_helper.dart';

import 'sqllite_helper.dart';
...
class SqlHome extends StatefulWidget {
  @override
  _SqlHomeState createState() => _SqlHomeState();
}
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Flutter SQLite Tutorial'),
        ),
        body: TabBarView(
          children: [
            Center(
